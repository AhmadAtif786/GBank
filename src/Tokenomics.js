  ...
  return (
    <Container id="Tokenomics">
      ...
      <Row className="mainmargin">
        <Col md={4} data-aos="fade-right" className="centerT">
          <div>
            <h2 className="tokenblock1">Titano Tokenomics Explained</h2>
            <br />
            <hr className="dev" />
            <br />
            <span className="tokenpara">
              $TITANO is a BEP-20 token with an elastic supply that rewards
              holders using a positive rebase formula.
            </span>
          </div>
        </Col>
        <Col md={4}>
          <div className="tokensecondblock" data-aos="fade-down">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="1" stop-color="#28E0B2"></stop>
                    </linearGradient>
                    <linearGradient
                      id="paint1_linear_207_123"
                      x1="55"
                      y1="355.119"
                      x2="355.119"
                      y2="55.1187"
            ...
            <br />
            <h3 className="automate">Automate LP</h3>

            <p className="autopara mt-3">
              5% of the trading fees return to the liquidity ensuring $TITANO's
              increasing collateral value.{" "}
            </p>
          </div>
          <div className="tokensecondblock mt-5" data-aos="fade-up">
            <div class="elementor-icon-box-icon">
              <span class="elementor-icon elementor-animation-">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  fill="none"
                >
                  <g filter="url(#filter0_f_207_125)">
                    <path
                      d="M350.994 122.863C349.657 121.337 348.02 120.103 346.184 119.238C344.348 118.373 342.354 117.897 340.326 117.838C308.816 117.014 268.945 83.3217 242.584 70.1C226.3 61.9582 215.55 56.5899 207.477 55.1758C205.838 54.9369 204.172 54.9415 202.534 55.1895C194.461 56.6037 183.711 61.972 167.441 70.1137C141.08 83.3217 101.209 117.014 69.6991 117.838C67.6694 117.9 65.6741 118.378 63.8366 119.242C61.9992 120.106 60.3589 121.339 59.0174 122.863C56.2367 126.009 54.8021 130.121 55.022 134.314C61.7908 271.927 111.149 357.093 197.756 406.588C200.008 407.865 202.507 408.524 204.992 408.524C207.477 408.524 209.976 407.865 212.241 406.588C298.848 357.093 348.193 271.927 354.975 134.314C355.208 130.122 353.777 126.007 350.994 122.863V122.863ZM282.126 176.986L209.042 284.833C206.42 288.705 202.301 291.272 198.223 291.272C194.132 291.272 189.587 289.034 186.718 286.165L135.204 234.637C133.522 232.949 132.577 230.663 132.577 228.28C132.577 225.897 133.522 223.612 135.204 221.923L147.931 209.168C149.623 207.493 151.907 206.554 154.288 206.554C156.669 206.554 158.953 207.493 160.645 209.168L194.145 242.669L252.346 156.762C253.692 154.796 255.762 153.443 258.103 152.998C260.444 152.553 262.866 153.052 264.84 154.387L279.737 164.492C281.705 165.836 283.061 167.905 283.508 170.246C283.956 172.587 283.459 175.01 282.126 176.986V176.986Z"
                      fill="url(#paint0_linear_207_125)"
                      fill-opacity="0.55"
                    ></path>
                  </g>
                  <path
                    d="M350.994 122.863C349.657 121.337 348.02 120.103 346.184 119.238C344.348 118.373 342.354 117.897 340.326 117.838C308.816 117.014 268.945 83.3217 242.584 70.1C226.3 61.9582 215.55 56.5899 207.477 55.1758C205.838 54.9369 204.172 54.9415 202.534 55.1895C194.461 56.6037 183.711 61.972 167.441 70.1137C141.08 83.3217 101.209 117.014 69.6991 117.838C67.6694 117.9 65.6741 118.378 63.8366 119.242C61.9992 120.106 60.3589 121.339 59.0174 122.863C56.2367 126.009 54.8021 130.121 55.022 134.314C61.7908 271.927 111.149 357.093 197.756 406.588C200.008 407.865 202.507 408.524 204.992 408.524C207.477 408.524 209.976 407.865 212.241 406.588C298.848 357.093 348.193 271.927 354.975 134.314C355.208 130.122 353.777 126.007 350.994 122.863V122.863ZM282.126 176.986L209.042 284.833C206.42 288.705 202.301 291.272 198.223 291.272C194.132 291.272 189.587 289.034 186.718 286.165L135.204 234.637C133.522 232.949 132.577 230.663 132.577 228.28C132.577 225.897 133.522 223.612 135.204 221.923L147.931 209.168C149.623 207.493 151.907 206.554 154.288 206.554C156.669 206.554 158.953 207.493 160.645 209.168L194.145 242.669L252.346 156.762C253.692 154.796 255.762 153.443 258.103 152.998C260.444 152.553 262.866 153.052 264.84 154.387L279.737 164.492C281.705 165.836 283.061 167.905 283.508 170.246C283.956 172.587 283.459 175.01 282.126 176.986V176.986Z"
                    fill="url(#paint1_linear_207_125)"
                  ></path>
                  <defs>
                    <filter
                      id="filter0_f_207_125"
                      x="0"
                      y="0"
                      width="410"
                      height="463.524"
            ...
            <br />
            <h3 className="automate">Treasury</h3>
        ...
        <Col md={4} className="centerT" data-aos="fade-left">
          <div className="tokensecondblock">
            <div class="elementor-icon-box-icon">
              <span class="elementor-icon elementor-animation-">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <br />
            <h3 className="automate">Risk Free Value</h3>
